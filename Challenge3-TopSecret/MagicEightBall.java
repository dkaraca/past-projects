//UIUC CS125 SPRING 2014 MP. File: MagicEightBall.java, CS125 Project: Challenge3-TopSecret, Version: 2014-02-14T21:53:34-0600.232432000
 /**
...
public class MagicEightBall {
	...
	public static void main(String[] args) {
		...
		// solution.
		if (social == true && happy == false && hours > 15) {
			TextIO.put("Rick Rolled Four Times in One Day");
		} else {
			if (social == true && happy == true && hours > 20) {
				TextIO.put("Ace CS125 Exam");
			} else if (happy == false && hours < 10) {
